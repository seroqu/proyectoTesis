 ...
 * @author Sebastian
 */
@WebServlet(name = "AdministracionAdmin", urlPatterns = {"/AdministracionAdmin"})
public class AdministracionAdmin extends HttpServlet {
        ...
        try {
            ...
            if(request.getMethod().equals("POST")){
               ...
               String password = request.getParameter("contrasena");
                ...
                ejbUsuario.getUsuario().setEmail(email);
                ejbUsuario.getUsuario().setPassword(password);
           
                if(ejbUsuario.registrarUsuarioAdmin()){
                   ...
                   response.sendRedirect("admin/registrarAdmin.jsp");
                }
            }
        } finally {            
            out.close();
